...
const Datatable_blocked_projects = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await fetch('https://fyp-ubit-backend.onrender.com/api/v1/admin/getBlockedProjects', {
          method: 'GET',
          headers: {
...
export default Datatable_blocked_projects;
